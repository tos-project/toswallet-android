...
import com.toscoin.core.coins.TosCoinMain;
import com.toscoin.core.network.CoinAddress;
...
public class Constants {
    ...
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
	        new CoinAddress(TosCoinMain.get(),

                    new ServerAddress("seed.tosblock.com", 50001),
                    new ServerAddress("seed.tosblock.com", 50002),
                    new ServerAddress("seed2.tosblock.com", 50001),
                    new ServerAddress("seed2.tosblock.com", 50002),
                    new ServerAddress("seed3.tosblock.com", 50001),
                    new ServerAddress("seed3.tosblock.com", 50002),
                    new ServerAddress("seed4.tosblock.com", 50001),
                    new ServerAddress("seed4.tosblock.com", 50002),

                    new ServerAddress("seed5.tosblock.com", 50001),
                    new ServerAddress("seed5.tosblock.com", 50002),
                    new ServerAddress("seed6.tosblock.com", 50001),
                    new ServerAddress("seed6.tosblock.com", 50002)

            )//,
                                                    //new ServerAddress("electrum6.cryptolife.net", 22010),
...
//                                                    new ServerAddress("ltc-cce-2.Coinomi.net", 5002))
    ...
    static {
		...
		COINS_ICONS.put(CoinID.NEWCOIN_MAIN.getCoinType(), R.drawable.toscoin);
...
//        COINS_BLOCK_EXPLORERS.put(CoinID.LITECOIN_MAIN.getCoinType(), "http://ltc.blockr.io/tx/info/%s");
    ...
    public static final CoinType DEFAULT_COIN = TosCoinMain.get();
    public static final List<CoinType> DEFAULT_COINS = ImmutableList.of((CoinType) TosCoinMain.get());
