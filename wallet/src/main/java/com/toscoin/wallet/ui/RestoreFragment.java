...
public class RestoreFragment extends Fragment {
    ...
    public static RestoreFragment newInstance(@Nullable String seed) {
        ...
        if (seed != null) {
            ...
            System.out.println("restore fragment : "+ seed);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            System.out.println("restore fragment onCreate: "+ seed);
    ...
    private void verifyMnemonicAndProceed() {
        ...
        if (verifyMnemonic()) {
            ...
            if (isSeedProtected) {
                ...
                System.out.println("restore fragment verify protected by 39: "+ seed);
            }
            args.putString(Constants.ARG_SEED, mnemonicTextView.getText().toString().trim());
            System.out.println("restore fragment verify "+ seed);
    ...
    public static class SkipDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            System.out.println("restore fragment onCreate2: "+ seed);
