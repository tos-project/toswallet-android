...
import com.toscoin.core.coins.FiatType;
...
import com.toscoin.core.messages.MessageFactory;
import com.toscoin.core.messages.TxMessage;
import com.toscoin.core.uri.CoinURI;
import com.toscoin.core.uri.CoinURIParseException;
...
import com.toscoin.wallet.AddressBookProvider;
...
import com.toscoin.wallet.tasks.MarketInfoPollTask;
import com.toscoin.wallet.ui.widget.AddressView;
import com.toscoin.wallet.ui.widget.AmountEditView;
import com.toscoin.wallet.util.ThrottlingWalletChangeListener;
...
import static com.toscoin.core.coins.Value.canCompare;
import static com.toscoin.wallet.ExchangeRatesProvider.getRates;
import static com.toscoin.wallet.util.UiUtils.setGone;
import static com.toscoin.wallet.util.UiUtils.setVisible;
    ...
    private final LoaderCallbacks<Cursor> rateLoaderCallbacks = new LoaderManager.LoaderCallbacks<Cursor>() {
        ...
        public void onLoadFinished(final Loader<Cursor> loader, final Cursor data) {
            if (data != null && data.getCount() > 0) {
                HashMap<String, com.toscoin.core.util.ExchangeRate> rates = new HashMap<>(data.getCount());
                data.moveToFirst();
                do {
